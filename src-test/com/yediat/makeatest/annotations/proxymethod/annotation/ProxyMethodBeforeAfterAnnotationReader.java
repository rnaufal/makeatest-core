...
public class ProxyMethodBeforeAfterAnnotationReader implements MakeATestReaderInterface<ProxyMethodBeforeAfterAnnotation> {
	...
	@Override
	public void readAnnotation(ProxyMethodBeforeAfterAnnotation annotation, AnnotationProperties descriptor) {
		...
		descriptor.setProcessor(proxyMethodBeforeAfterAnnotationProcessor);			
	}
