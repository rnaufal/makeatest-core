...
\title{Ferramenta baseada em metadados para verificar efeitos externos em testes de unidade}

% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Debora A. L. Chama}
\IEEEauthorblockA{Instituto Tecnológico de Aeronáutica – ITA\\
Pós-Graduação em Engenharia de Software\\
Praça Marechal Eduardo Gomes, 50\\
Vila das Acácias – CEP 12.228-900\\
São José dos Campos – SP – Brasil\\
Email: deborachama@gmail.com}
\and
\IEEEauthorblockN{Marcus V. C. Floriano}
\IEEEauthorblockA{Instituto Tecnológico de Aeronáutica – ITA\\
Pós-Graduação em Engenharia de Software\\
Praça Marechal Eduardo Gomes, 50\\
Vila das Acácias – CEP 12.228-900\\
