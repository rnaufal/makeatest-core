...
A test class is nothing more than a regular class with additional information that makes this class a test class. Below, in Figure 2 is presents a simple class and a class in Figure 3 with the additional information to be a test class:
...
Implementation of class execution annotation @FileExists.\\
