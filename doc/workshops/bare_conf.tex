...
\begin{IEEEkeywords}
 Unit Tests, Integration Tests, Metadata Framework.
\end{IEEEkeywords}
...
public class CommentTest {
  public void commentingOnAText() {
  }
  public void commentingOnAPhoto() {		
  }
}
\end{verbatim}
...
As future works we want to develop a study case using webservices to verify the external effects. Integrations with frameworks like Mockito and Seleinum are in our plans too. \\
...
\bibitem{GOF}
Gamma, Erich et al (2000). “Padrões de projeto: Soluções Reutilizáveis de Software Orientado a Objetos”, Bookman
