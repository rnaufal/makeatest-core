...
\newcommand{\tcctitle}{Ferramenta para validação de efeitos externos em teste de unidade}
...
\input{./cover.tex}
\input{./facepage.tex}
\input{./backfacepage.tex}
\input{./bankingpage.tex}
\input{./registrydocpage.tex}
...
\section{Contexto}
Na criação dos testes de um sistema, inicializar um cenário com dependências externas e verificar os efeitos externos de um teste é em geral muito trabalhoso. Verificar o estado do banco de dados, iniciar um servidor de aplicação, validar existência de recursos como arquivos, entre outros são exemplos de efeitos externos. É desejável que seja possível que o desenvolvedor crie seu teste de forma mais amigável, podendo tanto configurar seu cenário como realizar as verificações dos efeitos, por meio de metadados, de forma a tornar mais legível e amigável a criação do teste.
